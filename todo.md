...
- [x] **2024-01-17** Foreslå å fjerne "Basert på" med tanke på MVP, men snakke med ETI først med tanke på AI.
- [x] **2024-01-17** Guide for DCAT/CDV-NO-namespace (se også punkter nedenfor)
- [ ] **2024-01-17** Lage eksempel DCAT/CDV
- [x] **2024-01-17** Tone ned Schema.org (kan testes, men vil ikke være offisiell anbefaling)
...
- [ ] Skal de kunne kodes med f.eks. flere koder på nivå 2 (undertema) og 3 (emneord)?xs
...
- [x] Husk språkkoder - endelig forslag til bruk  
- [x] Følge opp mapping EY/Los-mapping: [https://github.com/Informasjonsforvaltning/behov/issues/444](https://github.com/Informasjonsforvaltning/behov/issues/444)
- [x] Gjøre om fotnoter til direkte lenker der det er naturlig
